...
exports.getRecentUserActions = getRecentUserActions;
...
function* getRecentUserActions(userId, historyEventTypes, date) {
    var toDate = arguments.length <= 3 || arguments[3] === undefined ? new Date(date.getTime() + DAY_MILLISECONDS) : arguments[3];
