...
var FOLLOWING_APP_APPROVED_HISTORY_MESSAGE = '{0} added {1} on AppHunt'
...
module.exports.FOLLOWING_APP_APPROVED_HISTORY_MESSAGE = FOLLOWING_APP_APPROVED_HISTORY_MESSAGE
