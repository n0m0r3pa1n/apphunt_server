...
var FlurryHandler = require('../build/handlers/utils/flurry_handler')
...
describe("Apps", function () {
    ...
    it("should get trending apps", function*() {
        var simple = require('simple-mock');
        var rp = require('request-promise')
        simple.mock(rp, "get", function() {
            return {
                parameters: {
                    key: [
                        {
        ...
        //var app3Id = (yield dbHelper.createAppWithPackage(userId, "package2")).result.id

        var user2Id = (yield dbHelper.createUserWithEmail("asdas")).result.id
        yield dbHelper.voteApp(app1Id, user2Id)

        yield dbHelper.createComment(app2Id, userId)

        var opts = {
            method: "GET",
            url: '/v1/apps/trending?userId=' + user2Id
        }
